...
RSpec.describe BasicHealthUnitsController, type: :controller do

  # This should return the minimal set of attributes required to create a valid
  # BasicHealthUnit. As you add validations to BasicHealthUnit, be sure to
  ...
  # BasicHealthUnitsController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "GET #show" do
    it "returns a success response" do
      ...
      get :show, params: {id: basic_health_unit.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested basic_health_unit" do
        basic_health_unit = BasicHealthUnit.create! valid_attributes
        put :update, params: {id: basic_health_unit.to_param, basic_health_unit: new_attributes}, session: valid_session
        basic_health_unit.reload
  ...
  describe "DELETE #destroy" do
    it "destroys the requested basic_health_unit" do
      basic_health_unit = BasicHealthUnit.create! valid_attributes
      expect {
